    ...
    return (
        <div className="dropdown">
            ...
            onChange={selectOption} >
                {activeCategory ? <option value={activeCategory.id} className="dropdown__option">{activeCategory.name}</option> : null}
                <option value="0" className="dropdown__option">Выберите категорию</option>
